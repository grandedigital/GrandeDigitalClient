  ...
  return (
    <section className="[background-image:_linear-gradient(135deg,transparent_45%,#d1b9b2_45%,#d1b9b2_55%,transparent_0)] [background-size:_5px_5px] bg-[--base-color] max-2xl:py-[90px] mt-[83px] max-mdx:py-[75px] max-md:py-[50px]">
      <div className="custom-container relative">
        <div className="row h-[180px] justify-center mdx:items-end">
          <div className="z-9 px-[15px] relative w-full max-w-full mdx:flex-[0_0_auto] mdx:w-1/2 max-mdx:mb-[30px] max-md:mb-[20px]">
          ...
          <div className="px-[15px] w-full max-w-full mdx:flex-[0_0_auto] mdx:w-1/2">
