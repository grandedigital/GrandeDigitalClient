    ...
    <section className="pb-0 max-2xl:pt-[90px] max-mdx:pt-[75px] max-md:pt-[50px]">
      <div className="custom-container">
        <div className="row mb-[4%]">
          ...
          <div className="px-[15px] text-center w-full max-w-full md:text-right md:flex-[0_0_auto] md:w-1/2">
            <Link
              href={"#"}
        ...
        <div className="row">
          <div className="flex-[0_0_auto] w-full max-w-full flex flex-wrap md:p-0">
            <ul className="p-0 m-0 w-full flex flex-wrap">
              <li className="w-1/3 p-[10px] list-none max-mdx:w-1/2 max-md:p-[10px] max-md:w-1/2 max-xsm:w-full">
                <div className="rounded-none bg-[--base-color] h-full border-0 overflow-hidden flex min-w-0 flex-col relative text-[--bs-body-color]">
